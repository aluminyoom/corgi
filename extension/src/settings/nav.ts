...
function deactivateKagiLinks(): void {
  ...
  for (const link of menu.querySelectorAll<HTMLAnchorElement>('a.nav-link:not(#corgi-nav-link)')) {
...
function createNavLink(): HTMLAnchorElement {
  ...
  link.className = 'nav-link ws-nowrap py-8 px-10 mx-n10 flex align-center rounded-full ws-normal';
